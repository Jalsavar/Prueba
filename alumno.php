                            ...
                            <div class="col-md-3">
                                <h1>Ingrese datos</h1>
                                    <form action="insertar.php" method="POST">
                                        ...
                                        <input type="text" class="form-control mb-3" name="Id_alumno" placeholder="Codigo alumno">
                                        <input type="text" class="form-control mb-3" name="nombre" placeholder="Nombre(s)">
                                        <input type="text" class="form-control mb-3" name="apaterno" placeholder="Apellido Paterno">
                                        <input type="text" class="form-control mb-3" name="amaterno" placeholder="Apellido Materno">
